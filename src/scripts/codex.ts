/* ═══════════════════════════════════════════════════════════════════════
   ...
   Reveal-on-scroll, nav background on scroll, smooth anchor scroll, and the
   one-time corner-ornament SVG sprite. Loaded once per page from CodexLayout.
   Ported verbatim from the prototype's assets/codex.js — framework-agnostic
   progressive enhancement over the static HTML (not an island).
   ═══════════════════════════════════════════════════════════════════════ */
